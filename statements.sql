...
-- Tu respuesta aquí
SELECT COUNT(*) AS total_usuarios FROM usuarios_lenguages;
...
-- Tu respuesta aquí
SELECT nombre, edad FROM usuarios_lenguajes WHERE edad = (SELECT MIN(edad) FROM usuarios_lenguaje);
...
-- Tu respuesta aquí
SELECT COUNT(*) AS mayores_de_28 FROM usuarios_lenguajes WHERE edad > 28;
...
-- Tu respuesta aquí
SELECT COUNT(*) AS lenguaje_asociado FROM usuarios_lenguajes WHERE lenguaje = 'Python';
...
-- Tu respuesta aquí
SELECT COUNT(*) AS css_menor_de_30 FROM usuarios_lenguaje WHERE lenguaje = 'CSS' AND edad < 30;

-- Ejercicio 21: Seleccionar los usuarios que tienen al menos un lenguaje asociado y mostrar la cantidad de lenguajes que tienen.
-- Tu respuesta aquí
SELECT nombre, COUNT(lenguaje) AS cantidad_lenguaje FROM usuarios_lenguajes GROUP BY nombre;
...
-- Tu respuesta aquí
SELECT * FROM usarios_lenguaje WHERE edad < 30 AND CHAR_LENGHT(lenguage) = (
	SELECT MAX(CHAR_LENGTH(lenguaje)) FROM usuarios_lenguajes WHERE edad < 30
);
...
-- Tu respuesta aquí
SELECT COUNT(*) AS apellido_letraG FROM usuarios_lenguajes WHERE apellido LIKE 'G%';
...
-- Tu respuesta aquí
SELECT COUNT(*) AS edad_2025_lenguaje FROM usuarios_lenguajes WHERE edad BETWEEN 20 AND 25 AND lenguaje IS NOT NULL;
...
-- Tu respuesta aquí
SELECT COUNT(*) AS lenguaje_palabra_script FROM usuarios_lenguajes WHERE lenguaje LIKE '%Script%';
...
-- Tu respuesta aquí
SELECT COUNT(*) AS lenguajeP_menos28 FROM usuarios_lenguajes WHERE lenguaje LIKE 'P%' AND edad < 28;
